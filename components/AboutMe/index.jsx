      ...
      <div className="container flex-col-reverse md:flex-row flex items-center px-8 pb-8 md:py-20 gap-8">
        <section className="flex flex-1 flex-col gap-8 md:items-start">
          ...
          <p className="md:w-4/6 text-lg">
            I described myself as a creative, and willing to learn new. As a
            front-end developer I am very interested in topics about web
            application development using React.js and React Native.
          </p>
          {false && (
            <a
