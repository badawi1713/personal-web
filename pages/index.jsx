        ...
        <div className="container max-w-7xl flex-col-reverse md:flex-row flex items-center px-8 py-20 gap-8">
          <section className="flex flex-1 flex-col gap-8 md:items-start">
            ...
            <p className="md:w-4/6 text-lg">
              Hello, thank you for taking the time to visit. I am Dzaky, a{" "}
              <em>ramenthusiast</em> guy and Frontend developer. On this website
              you can read my personal blog and the juicy bits about me, or find
              out why you should hire me.
            </p>
            <div className="flex flex-col md:flex-row gap-4">
              {false && (
                <Link passHref href="/blog">
                  <button className=" bg-red-400 hover:bg-red-500 dark:bg-sky-400 hover:dark:bg-sky-500  py-4 px-8 rounded-lg hover:-translate-y-1 transition text-white ">
                    Read my Blog
                  </button>
                </Link>
              )}
              <Link passHref href="/portfolio">
                <button className="border border-red-400 hover:border-red-500 dark:border-sky-400 hover:dark:border-sky-500 py-4 px-8 rounded-lg hover:-translate-y-1 transition ">
                  About Me
                </button>
              </Link>
            </div>
            ...
            <div className="h-44 w-44 md:w-64 md:h-64 lg:w-72 lg:h-72 bg-white rounded-full absolute top-0 right-0">
              <div className="h-full w-full rounded-full relative">
                <Image
                  ...
                  layout="fill"
                  alt="Dzaky Badawi | Frontend Engineer"
                />
              </div>
            </div>
          </section>
